<div class="lg:w-1/4 md:w-1/2 p-4 w-full">
    ...
    <div class="mt-4">
      ...
      @if ($product->category_id == 1)
        <h3 class="text-gray-600 text-xs font-bold tracking-widest title-font mb-1">Memorial Service</h3>
      @else
          <h3 class="text-gray-600 text-xs font-bold tracking-widest title-font mb-1">Direct Cremation</h3>
      @endif

  ...
  <div class="flex w-full justify-center items-start py-6">
      <div class="mx-auto w-1/2">
          <div class="border-b-2 border-gray-300 p-2">
              <h1 class="text-xl text-blue-500 font-bold">ADD HEARSE</h1>
          </div>
            <form method="POST" enctype="multipart/form-data" action="/hearse/store" class="flex flex-col w-full p-2">
              @csrf
              <div class="flex flex-col space-y-2 mt-3">
                  <label for="name">HEARSE NAME</label>
              ...
              <div class="flex space-x-4 mt-3">
                  ...
                  <div class="flex flex-col space-y-2 w-full">
                      ...
                      <input type="file" name="image" id="image" accept="image/*" class="text-sm rounded border border-gray-300 w-full">
                      @error('image')
                          <p class="text-red-500 text-xs">{{$message}}</p>
                      @enderror
                  </div>
              ...
              <div class="flex space-x-2 mt-3">
                <div class="flex flex-col space-y-2 w-full">
                  <label for="images">HEARSE IMAGES</label>

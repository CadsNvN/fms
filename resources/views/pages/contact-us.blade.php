<x-welcome-layout>
  <section class="text-gray-600 body-font relative flex flex-row">
    <div class="relative w-1/2 h-auto">
      <img src="{{ asset('images/candle.jpg') }}" alt="candle" class="">
    </div>
    <div class="px-5 py-24 mx-auto">
      <div class="flex flex-col text-center">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Contact Us</h1>
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base font-semibold">For more information see the contact below.</p>
      </div>
      <div class="lg:w-1/2 md:w-2/3 mx-auto">
        <div class="flex flex-wrap -m-2">
          ...
          <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
            <a class=" text-slate-600"> 📬 torresescarofuneral@email.com</a>
